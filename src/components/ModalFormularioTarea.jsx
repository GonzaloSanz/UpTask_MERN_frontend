...
const ModalFormularioTarea = () => {
    const { modalFormularioTarea, setModalFormularioTarea, nuevaTarea, editarTarea, tarea } = useContext(ProyectosContext);
    ...
    const handleSubmit = async e => {
        ...
        if ([nombre.trim(), descripcion.trim(), fechaEntrega, prioridad].includes('')) {
        ...
        if(id) {
            await editarTarea({ id, nombre, descripcion, fechaEntrega, prioridad });
        } else {
            await nuevaTarea({ proyecto: params?.id, nombre, descripcion, fechaEntrega, prioridad });
        }
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                            ...
                            <div className="sm:flex sm:items-start">
                                <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <form onSubmit={handleSubmit} className='m-2 mt-6'>
                                        <div className="mb-5">
                                        ...
                                        <div className="mb-5">
                                            ...
                                            <select
                                                id="prioridad"
                                                className="border w-full bg-white p-2 my-2 rounded-md"
                                                value={prioridad}
                                        ...
                                        <input
                                            type='submit'
                                            className='bg-sky-600 hover:bg-sky-600 w-full p-3 text-white uppercase font-bold rounded-md cursor-pointer transition-colors'
